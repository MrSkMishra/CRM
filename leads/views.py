...
class CategoryListView(OrganisorAndLoginRequiredMixin, generic.ListView):
    ...
    def get_queryset(self):
        user = self.request.user
        # initial queryset of Category for the entire organisation.
        if user.is_organisor:
...
# LONG METHOD SUCH WHEN USER WANTS ONLY ONE FIELD DATA THEN BEOW LINES WORK BUT NOW IT'S NOT USEFULL FOR ME
